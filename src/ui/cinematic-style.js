...
const CSS = `
.eojeon{--royal-gold:#d6a64c;--royal-ink:#10130f;color:#eee6d3;font-family:'Malgun Gothic',sans-serif}
...
.eojeon .note .sheet{max-width:660px;border-radius:0;border:0;border-top:3px solid #c59b54;padding:32px 38px;background-image:none !important;background-color:#efe3cceF;box-shadow:0 24px 90px #0008}
.eojeon .note p{font-size:17px;line-height:1.85}
.eojeon .note .origin{font-size:12px;line-height:1.7}
.eojeon .note h2{font-family:Batang,serif;letter-spacing:.12em;font-size:25px}
.eojeon .note button{background:#732d26;color:#fff0d0;border-color:#a57648;letter-spacing:1px}
...
.eojeon .veil .card{border-radius:0;border-top:4px solid #923e30;max-width:670px;padding:32px 38px;box-shadow:0 22px 85px #0009}
.eojeon .card h3{font-family:Batang,serif;font-size:27px;margin-bottom:12px}
.eojeon .card .excerpt{font-size:17px;line-height:1.95}
...
@media(max-width:760px){
 ...
 .eojeon .note .sheet{padding:25px 20px}.eojeon .note p{font-size:16px}
